...
import type { AuthSession, RegisterPayload, EmailStatus } from '../types';
...
/**
 * Exchanges the Supabase token_hash (embedded in the confirmation-email
 * link) for a real session. Called by ConfirmPage after parsing the URL.
 */
