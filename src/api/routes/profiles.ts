...
import type { ProfileRelationshipSummary, ProfileRow, UpdateProfilePayload } from '../types';
...
export function getProfileRelationship(userId: string) {
  return request<ProfileRelationshipSummary>(`/profiles/${userId}/relationship`);
}
