...
import { Bell, ArrowRight, UserPlus, MessageCircle, CheckCheck, Drama } from 'lucide-react';
...
function NotifRow({ notif, onClick }: { notif: Notification; onClick: () => void }) {
  const iconMap: Record<Notification['type'], React.ReactNode> = {
    ...
    anon_match: <Drama size={17} />,
    new_follower: <UserPlus size={17} />,
  };
