          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-8 h-20 sm:h-[84px] flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex items-center gap-4 font-mono text-xs uppercase tracking-wider text-[#1A6B3C]/75 dark:text-gray-300 mr-4">
                ...
                <Link to="/terms" className="text-[#1A6B3C] dark:text-white font-bold underline underline-offset-8 decoration-[#E8A838] decoration-2">Terms</Link>
          ...
          <section className="border-t border-[#1A6B3C]/15 dark:border-white/10 py-16 sm:py-24 px-4 sm:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              ...
              <motion.div
                ...
                className="lg:col-span-7 space-y-6 lg:border-l lg:border-[#1A6B3C]/15 dark:lg:border-white/10 lg:pl-16"
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="font-jakarta text-gray-800 dark:text-gray-200 text-base sm:text-lg leading-relaxed">
                    Ally-jis is a community for making connections. Please treat other users with respect.
                  </p>
                  <p className="font-mono text-xs uppercase tracking-wider text-[#B45309] dark:text-amber-400 font-bold pt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 pt-2">
                    {prohibitedItems.map((item, index) => (
                      <motion.div
                        ...
                        className="flex items-start gap-3 py-2 border-b border-[#1A6B3C]/10 dark:border-white/10 font-jakarta text-sm text-gray-700 dark:text-gray-300"
                      >
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="font-jakarta text-gray-800 dark:text-gray-200 text-base sm:text-lg leading-relaxed space-y-3">
                    ...
                    <p className="font-medium text-[#1A6B3C] dark:text-emerald-400">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="font-jakarta text-gray-800 dark:text-gray-200 text-base sm:text-lg leading-relaxed space-y-3 max-w-xl">
                    <p>
                    ...
                    <p className="font-bold text-[#1A6B3C] dark:text-emerald-400 text-xl font-fraunces italic pt-1">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.15 }}
                className="lg:col-span-5 space-y-6 lg:border-l lg:border-[#1A6B3C]/15 dark:lg:border-white/10 lg:pl-16"
              >
                <span className="font-fraunces text-7xl sm:text-8xl font-bold text-[#1A6B3C]/20 dark:text-white/20 leading-none block">
                  06
                </span>
          ...
          <section className="py-20 sm:py-28 px-4 sm:px-8 max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 items-start">
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <span className="font-fraunces text-6xl font-bold text-[#1A6B3C]/20 dark:text-white/20 leading-none block">
                  07
                </span>
