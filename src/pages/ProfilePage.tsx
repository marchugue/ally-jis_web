  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden h-full w-full bg-white">
      <div className="flex-1 flex flex-col lg:flex-row min-h-0 h-full w-full overflow-hidden">
        ...
        <div className="hidden lg:flex w-[380px] xl:w-[420px] bg-white border-l border-gray-100 flex-col p-6 space-y-6 overflow-y-auto flex-shrink-0 animate-pulse">
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden h-full w-full bg-white">
      ...
      <div className="flex-1 flex flex-col lg:flex-row min-h-0 h-full w-full overflow-hidden">
        ...
        ══════════════════════════════════════════════════════════ */}
        <div className={cn(
          'w-full lg:w-[380px] xl:w-[420px] bg-white border-t lg:border-t-0 lg:border-l border-gray-100 flex flex-col min-h-0 flex-shrink-0 overflow-y-auto custom-scrollbar',
