    ...
    <div className="relative border-b border-gray-50">
      ...
      >
        <div className="relative flex-shrink-0">
          {isAnonymous ? (
            <AnonymousAvatar avatarKey={conv.matchInfo?.partnerAvatar} size={48} className="rounded-2xl" />
          ) : (
        ...
        <div className="flex-1 min-w-0 text-left">
          <div className="flex justify-between items-baseline mb-0.5">
            <h4 className="font-jakarta font-bold text-gray-900 truncate flex items-center gap-1.5">
              {conv.participantName}
              {isAnonymous && <Drama size={12} className="text-[#3B8C7E] shrink-0" />}
            </h4>
            <span className={cn(
