  ...
  return (
    <div className="overflow-y-auto h-full">
      {conversations.map((conv) => {
        const isOnline = onlineUserIds?.has(conv.participantId);
        const sentByMe = Boolean(currentUserId) && conv.lastMessageSenderId === currentUserId;
        ...
        return (
          <button
            ...
            className={cn(
              ...
              activeId === conv.id ? "bg-[#1A6B3C]/5" : isUnreadFromThem ? "bg-[#1A6B3C]/[0.03] hover:bg-[#1A6B3C]/5" : "hover:bg-gray-50"
            )}
          >
            ...
            <div className="flex-1 min-w-0 text-left">
              <div className="flex justify-between items-baseline mb-0.5">
                <h4 className={cn(
                  "font-jakarta truncate",
                  isUnreadFromThem ? "font-bold text-gray-900" : "font-bold text-gray-900"
                )}>
