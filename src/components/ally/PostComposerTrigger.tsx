...
export default function PostComposerTrigger({ currentUser, onClick }: PostComposerTriggerProps) {
  return (
    <button
      onClick={onClick}
      className="w-full bg-white border-b border-[#1A6B3C]/6 lg:rounded-xl lg:border lg:card-shadow p-4 mb-3 flex items-center gap-3 hover:lg:card-shadow-hover transition-shadow"
    >
