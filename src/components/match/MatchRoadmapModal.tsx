...
const ROADMAP_STAGES: RoadmapStage[] = [
  {
    ...
    description: 'Connect without judgment using persona identities, text messaging, icebreakers, and emoji reactions.',
  ...
  },
  {
    id: 2,
    number: '02',
    tag: 'STAGE 2 • COMING SOON',
    streakLabel: '3-Day Streak',
    title: 'Play Games Together',
    subtitle: 'Interactive Peer Games',
    description: 'Bond through cooperative campus games and quizzes with your match (Flagged To-Do: Coming Soon).',
    perks: ['Interactive campus mini-games (Coming Soon)', 'Shared interest quizzes', 'Compatibility games'],
    icon: Sparkles,
  ...
  },
  {
    ...
    subtitle: 'Chat Media Unlocked',
    description: 'Upload and share campus moments, study notes, and photos directly in your conversation.',
    perks: ['Upload images in chat', 'Media preview strip', 'Shared campus photos'],
    icon: Users,
  ...
  },
  {
    id: 4,
    number: '04',
    tag: 'STAGE 4 • UNLOCK ALLIES',
    streakLabel: '10-Day Streak',
    title: 'Campus Allies',
    subtitle: 'Automatic Identity Reveal',
    description: 'Finish the roadmap to automatically become verified campus allies and unlock full profile identities.',
    perks: ['Real student name', 'Unblurred profile photo', 'Course & academic program', 'Permanent Ally relationship'],
    icon: Unlock,
